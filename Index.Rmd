...
!!!!!!!!! A MAP OF THE COUNTRIES WE'LL BE LOOKING AT!!!!!!!!!!!!
...
# Individual graphs for every country, and includes both cases and deaths per capita.
ggplot() +
  geom_line(data = NonUniversalByPop, aes(x = Date_reported, y = CasesPerCapita, color = "Cases")) +
  geom_line(data = NonUniversalByPop, aes(x = Date_reported, y = DeathsPerCapita, color = "Deaths")) +
  facet_wrap(~ Country_name) +
  ggtitle("Figure 5: Cumulative Cases to Deaths, Per Capita, in Countries with Non-Universal Healthcare") +
  labs(x = "Month", y = "Cases and Deaths Per Capita") +
  scale_y_log10()

ggplot() +
  geom_line(data = UniversalByPop, aes(x = Date_reported, y = CasesPerCapita, color = "Cases")) +
  geom_line(data = UniversalByPop, aes(x = Date_reported, y = DeathsPerCapita, color = "Deaths")) +
  facet_wrap(~ Country_name) +
  ggtitle("Figure 6: Cumulative Cases to Deaths, Per Capita, in Countries with Non-Universal Healthcare") +
  labs(x = "Month", y = "Cases and Deaths Per Capita") +
  scale_y_log10()
```

This report's purpose is not to analyze cases, but these graphs allow us to see which countries have been able to keep their deaths from increasing as quickly as their cases, and the tables allow us to compare how well each healthcare system performs in the case to death ratio.  !!!!!!!!!!!!!!!! ADD TABLES !!!!!!!!!!!!!!

Notably, Burundi, Bhutan, and Botswana have been able to virtually halt their deaths even though their cases continue to climb. The same cannot be said of Italy, where there appears to be a short time period where their deaths came horrifyingly close to their number of cases.
